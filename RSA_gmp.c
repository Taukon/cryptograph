...
int main(void){
    ...
    for(int i=0; i<aaa; i++){
        ...
        mpz_powm(decrypted[i],encrypted[i],d,n);
    ...
    //p,q,rop,n,e,d,,p_1,q_1,l,stateのメモリ開放
    mpz_clears(p,q,rop,e,d,n,p_1,q_1,NULL);
    gmp_randclear(state);
